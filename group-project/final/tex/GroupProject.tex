...
Most of the data by hour shows lower count frequencies with the max at 0 - 400
...
\ddsubsec{lin-reg-res}{Linear and Non-Linear Regression}
...
The processed data mentioned in \ddsecref{feat-sel} yielded an R-squared training data
value of 0.646.  The RMSE of the predicted values is 163.3292.
...
\ddsubsec{svm-res}{SVM Regression}
