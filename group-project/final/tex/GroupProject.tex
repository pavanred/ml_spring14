...
\newcommand{\doctype}{Capital BikeShare Predictive Data Analysis Project Report}
...
classification, SVM, and decision trees.  Both linear regression and SVM was used
for prediction while logistical regression, na{\"i}ve Bayesian classification,
SVM and decision trees were used for classification.
