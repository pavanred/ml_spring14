...
\newcommand{\doctitle}{Machine Learning Progress Report 2014 Spring}
...
The weather condition in our data set has a lot of impact on the usage of
...
currently building statistical models for this and estimating the number of
both kinds of users (registered and casual users).
...
%\ddfigure{\textwidth}{cross_validation}{Cross Fold Validation}
